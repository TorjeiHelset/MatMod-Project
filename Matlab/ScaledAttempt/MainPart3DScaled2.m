...
jsonfile = fileread('diffusionMainPart2.json');
...
paramobj.N.D = paramobj.N.D * (1/Lxy^2);
kappa = paramobj.N.D;
...
G = cartGrid([nxy,nxy,nz]); % z-scale not fully correct
...
% setup schedule
total = 1000*T; % Only simulate till timescale we found
n  = 100;
dt = total/n;
