classdef ReactionDiffusionInputParamsMainPartScaled < InputParams
    ...
    properties
        ...
        k1_N % Different reaction rates for N
        k_1_N
    ...
    methods
        ...
        function paramobj = ReactionDiffusionInputParamsMainPartScaled(jsonstruct)
            ...
            paramobj.k1_N = paramobj.k1;
            paramobj.k_1_N = paramobj.k_1;
