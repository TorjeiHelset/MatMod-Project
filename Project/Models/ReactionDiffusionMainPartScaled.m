classdef ReactionDiffusionMainPartScaled < BaseModel
    ...
    methods
        ...
        function model = ReactionDiffusionMainPartScaled(paramobj)
        ...
        function state = updateSourceTerm(model, state)
            ...
            R1 = k1.*vols.*cN.*cR;         
            R_1 = k_1.*vols.*cC;
            R1_N = k1_N.*vols.*cN.*cR;
            R_1_N = k_1_N.*vols.*cC;

            state.N.source = -R1_N + R_1_N;
