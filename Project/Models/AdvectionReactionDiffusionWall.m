classdef AdvectionReactionDiffusionWall < BaseModel
    ...
    methods
        ...
        function model = AdvectionReactionDiffusionWall(paramobj)
            ...
            model.N = AdvectionDiffusionComponentWall(paramobj.N);
            ...
            model.N_inac = AdvectionDiffusionComponentWall(paramobj.N_inac);
